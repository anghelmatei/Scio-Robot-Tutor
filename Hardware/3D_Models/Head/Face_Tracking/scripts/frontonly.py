...
def main() -> None:
    ...
    # load cascade file for frontal face detection
    face_cascade = cv2.CascadeClassifier('../trained_data/haarcascade_frontalface_default.xml')

    # initialize variables for face tracking
    prev_face = None
    frame_count = 0
    face_detection_interval = 1  # Adjust this value to change the frequency of face detection
    prev_quadrant = None
